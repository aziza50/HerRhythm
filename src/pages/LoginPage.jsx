...
const bgImage =
  "https://www.figma.com/api/mcp/asset/a9c15f6e-7617-49ff-9189-de4819acab2b"; // same bg
const paperTexture =
  "https://www.figma.com/api/mcp/asset/a13ec45d-162d-4fd5-9da5-32b47a0e084a"; // same paper
    ...
    <div className="relative w-full min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen">
        <div className="relative w-[400px] h-[640px] bg-[rgba(255,255,255,0.85)] rounded-[64px] shadow-[0_10px_0_1px_#5A5A5A] overflow-hidden flex flex-col justify-center items-center">
          ...
          {/* Login button */}
          <div className="relative z-10 mt-6 px-6 py-3 bg-pink-400 text-white font-bold rounded-2xl shadow-md 
